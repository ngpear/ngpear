...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="{{ url('admin/article') }}" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="{{ url('admin/brand') }}" data-title="品牌管理" href="javascript:void(0)">品牌管理</a></li>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{ url('admin/member') }}" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
					<li><a data-href="{{ url('admin/level') }}" data-title="等级管理" href="javascript:;">等级管理</a></li>
					<li><a data-href="{{ url('admin/record') }}" data-title="浏览记录" href="javascript:void(0)">浏览记录</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-admin">
